            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="recuperaSenhaform" class="form-horizontal" role="form" 
                        action="<?= SITEURL ?>Login/atualizaRecuperaSenha">

                        <input type="hidden" name="id" id="id" value="<?= $dbDados['id'] ?>">
                        <input type="hidden" name="usuariorecuperasenha_id" id="usuariorecuperasenha_id" value="<?= $dbDados['usuariorecuperasenha_id'] ?>">
                        
                        <div style="margin-bottom: 25px" class="input-group">
                            <label class="ml-1">Olá <b><?= $dbDados['nome'] ?></b>! Para prosseguir com a recuperação da senha basta digitar a senha nos campos abaixo e clicar em atualizar.</label>                            
                        </div>
